...
int main(int argc, char *argv[])
{
  ...
  /* Inint TTF. */
    ...
    SDL_Rect text_Rect;
    charge_text(screen, 0, 0, "Project done by MIRMOHAMMADI Ali & WANG Jinniu(oct28)", font, &texture_Text, &text_Rect);
    int alpha_text =0; 
    int cnt1=0;
  //----------------------------------------
  ...
  int dx,dy,GLOBAL_OBJ_SELECTED, GLOBAL_OBJ_HIGHLIGHTED;
	...
	case SDL_MOUSEBUTTONDOWN:
          ...
          switch (evenements.button.button)
          {
            ...
            case SDL_BUTTON_LEFT:
              ...
              mouse_trigger(&mouse_point, tab_obj, &GLOBAL_OBJ_SELECTED,nbobj,&dx, &dy);
        ...
        case SDL_MOUSEBUTTONUP:
          printf("%d\n",GLOBAL_OBJ_SELECTED);
          mouse_release(&tab_obj[GLOBAL_OBJ_SELECTED], &GLOBAL_OBJ_SELECTED, &terrain);
        ...
        case SDL_MOUSEMOTION:
          mouse_point.x = evenements.motion.x;
          mouse_point.y = evenements.motion.y;
          mouse_rollover(&mouse_point,tab_obj, &GLOBAL_OBJ_SELECTED, &GLOBAL_OBJ_HIGHLIGHTED, &dx, &dy,&nbobj);
